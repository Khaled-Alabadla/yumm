...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Yumm",
    "site_brand": "Yumm",
    "site_logo": "admin/img/yumm-brand.svg",
    "login_logo": "admin/img/yumm-brand.svg",
    "site_icon": "admin/img/yumm-brand.svg",
    ...
    # Single search bar in navbar (was 2 — cluttered the top bar)
    "search_model": ["restaurants.Restaurant"],

    # Top navbar — keep minimal; sidebar handles full navigation
    "topmenu_links": [
        {
            "name": _("Dashboard"),
            "url": "admin:index",
